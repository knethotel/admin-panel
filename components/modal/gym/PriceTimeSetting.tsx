...
import {
  PriceTimeSettingGymSchema,
  PriceTimeSettingGymSchemaType
} from 'schema';
...
const PriceTimeSettingGym: React.FC<ModalProps> = ({ isOpen, onClose }) => {
  const form = useForm<PriceTimeSettingGymSchemaType>({
    resolver: zodResolver(PriceTimeSettingGymSchema),
    defaultValues: {
      priceType: 'Free',
      price: 0,
                    ...
                    <FormControl>
                      ...
                      >
                        ...
                        <SelectContent className="bg-[#362913] text-nowrap rounded-2xl text-white border-2 shadow-md border-white">
                          {['Community Hall', 'Conference Hall', 'Gym'].map(
                            (value) => (
                              <SelectItem
                                key={value}
                                value={value}
...
export default PriceTimeSettingGym;
