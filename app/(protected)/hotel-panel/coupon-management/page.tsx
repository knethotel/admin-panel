      ...
      <div className="min-h-screen w-full flex justify-center pt-6 mt-12">
        <div className="flex flex-col w-full gap-3 container">
          <div className="flex justify-between items-center w-full">
            ...
            <Button
              onClick={() =>
                router.push(`/hotel-panel/coupon-management/create`)
              }
          ...
          <div className="flex flex-col bg-[#FAF6EF] shadow-custom p-6 pb-10 w-full gap-8">
            ...
            <div className="space-y-2">
              <p className="inline-block font-medium text-lg">
                Percentage Coupons
              </p>
                    ...
                    >
                      ...
                      <div className="absolute w-full -bottom-8 flex justify-between items-center px-4">
                        <button
                          onClick={() =>
                            router.push(
                              `/hotel-panel/coupon-management/view/${coupon._id}`
                            )
                          }
                        ...
                        <SquarePen
                          ...
                          onClick={() =>
                            router.push(
                              `/hotel-panel/coupon-management/edit/${coupon._id}`
                            )
                          }
                        />
                        <Trash2
